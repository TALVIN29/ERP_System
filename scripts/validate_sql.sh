...
fail=0
for f in supabase/01_schema.sql supabase/02_rls.sql supabase/03_insights.sql supabase/04_seed.sql supabase/05_metrics.sql supabase/06_grants.sql supabase/07_perf.sql supabase/08_perf2.sql supabase/09_insights_perf.sql supabase/10_scope_perf.sql; do
  echo
  echo "=== $f ==="
  if run -q < "$f"; then
    echo "OK"
